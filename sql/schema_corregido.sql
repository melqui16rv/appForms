-- Script de creación de base de datos para el sistema de diseños curriculares (CORREGIDO)
-- Crear base de datos
...
-- Tabla de diseños (sin tildes para compatibilidad)
CREATE TABLE `disenos` (
    `codigoDiseno` VARCHAR(255) NOT NULL COMMENT 'Formato: codigoPrograma-versionPrograma (ej: 124101-1)',
    ...
    `horasDesarrolloDiseno` DECIMAL(10,2) NOT NULL,
    `mesesDesarrolloDiseno` DECIMAL(10,2) NOT NULL,
...
CREATE TABLE `competencias` (
    `codigoDisenoCompetencia` VARCHAR(255) NOT NULL COMMENT 'Formato: codigoDiseno-codigoCompetencia (ej: 124101-1-220201501)',
    ...
    `fechaCreacion` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    `fechaActualizacion` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY(`codigoDisenoCompetencia`),
...
CREATE TABLE `raps` (
    `codigoDisenoCompetenciaRap` VARCHAR(255) NOT NULL COMMENT 'Formato: codigoDiseno-codigoCompetencia-codigoRap (ej: 124101-1-220201501-RA1)',
    `codigoRap` VARCHAR(55) NOT NULL,
    `nombreRap` TEXT NOT NULL,
    `horasDesarrolloRap` DECIMAL(10,2) NOT NULL,
    `fechaCreacion` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    `fechaActualizacion` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY(`codigoDisenoCompetenciaRap`),
...
INSERT INTO `disenos` (
    ...
    `redTecnologica`, `redConocimiento`, `horasDesarrolloDiseno`, `mesesDesarrolloDiseno`,
